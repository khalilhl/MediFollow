          ...
          <Card>
            <Card.Header className="d-flex justify-content-between align-items-center">
              <div className="header-title">
                <h4 className="card-title">Ajouter un Auditeur</h4>
              </div>
            </Card.Header>
            <Card.Body>
              ...
              <Form onSubmit={handleSubmit}>
                ...
                <Row className="g-3">
                  ...
                  <Col md={6}>
                    <Form.Group>
                      ...
                      <Form.Control type="text" name="address" placeholder="Adresse" />
                    </Form.Group>
                  </Col>
                  <Col md={6}>
                    <Form.Group>
                ...
                <div className="d-flex gap-2 mt-4">
                  <Button type="submit" variant="primary" disabled={loading}>
                    {loading ? <><span className="spinner-border spinner-border-sm me-2" />Enregistrement...</> : "Ajouter l'auditeur"}
                  </Button>
                  <Button variant="outline-secondary" onClick={() => navigate("/super-admin/auditors")}>Annuler</Button>
                </div>
              </Form>
            </Card.Body>
          </Card>
