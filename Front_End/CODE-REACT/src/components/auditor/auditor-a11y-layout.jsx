...
/**
 * Enveloppe session auditeur : provider d’état + lien d’évitement.
 * La barre d’accessibilité doit être rendue dans chaque page (voir AuditorA11yToolbar)
 * en premier enfant de .auditor-dash / .auditor-logs pour l’alignement des largeurs.
 */
